...
public class BlockFluidSpectraSlurry extends BlockFluidClassic
{
    ...
    public BlockFluidSpectraSlurry(Fluid fluid, Material material)
    {
        ...
        setBlockName(ModNames.SPECTRA_SLURRY);
    }
    ...
    {
        stillIcon = iconRegister.registerIcon(ModData.MODID + ":" + ModNames.SPECTRA_SLURRY + "_still");
        flowingIcon = iconRegister.registerIcon(ModData.MODID + ":" + ModNames.SPECTRA_SLURRY + "_flowing");
    }
