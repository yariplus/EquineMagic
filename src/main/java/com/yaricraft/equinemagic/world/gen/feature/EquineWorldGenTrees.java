 ...
 */
public class EquineWorldGenTrees extends WorldGenTrees
{
    ...
    public EquineWorldGenTrees(boolean notify)
    {
        this(notify, 4, 0, 0, false);
    }

    public EquineWorldGenTrees(boolean notify, int minTreeHeight, int metaWood, int metaLeaves, boolean vinesGrow)
    {
        super(notify);
            ...
            else
            {
                ...
                if (isSoil && y < 256 - l - 1)
                {
                        ...
                        for (i2 = x - l1; i2 <= x + l1; ++i2)
                        {
                            ...
                            for (int k2 = z - l1; k2 <= z + l1; ++k2)
                            {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || random.nextInt(2) != 0 && i3 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndNotifyAdequately(world, i2, k1, k2, EquineMagicBlock.equine_leaves, this.metaLeaves);
                                    }
                                }
                            }
                        }
                    ...
                    for (k1 = 0; k1 < l; ++k1)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(world, x, y + k1, z, EquineMagicBlock.equine_log, this.metaWood);
