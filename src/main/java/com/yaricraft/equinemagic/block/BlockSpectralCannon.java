...
public class BlockSpectralCannon extends BlockEHorizontalPillar implements ITileEntityProvider
{
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack)
    {
        ...
        {
            ((TileSpectralCannon)world.getTileEntity(x, y, z)).tank.setFluid(new FluidStack(EquineMagicFluid.fluidSpectraSlurry, itemStack.getTagCompound().getCompoundTag("FluidStack").getInteger("Amount")));
        }
    }
    ...
    public void breakBlock(World world, int x, int y, int z, Block block, int meta)
    {
        ...
        if (tileEntity != null)
        {
            ...
            {
                TileSpectralCannon cauldron = (TileSpectralCannon) tileEntity;
                //if (captureDrops.get())
                //{
